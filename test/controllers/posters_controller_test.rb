...
class PostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poster" do
    assert_difference("Poster.count") do
      post posters_url, params: { poster: { campaign_id: @poster.campaign_id, lat: @poster.lat, long: @poster.long, url: @poster.url } }
    end
  ...
  test "should update poster" do
    patch poster_url(@poster), params: { poster: { campaign_id: @poster.campaign_id, lat: @poster.lat, long: @poster.long, url: @poster.url } }
